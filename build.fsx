...
Target "Lib_Build" (fun _ -> build "Be.Vlaanderen.Basisregisters.AspNetCore.Mvc.Middleware.AddVersionHeader")
Target "Lib_Test" (fun _ -> test "Be.Vlaanderen.Basisregisters.AspNetCore.Mvc.Middleware.AddVersionHeader")

Target "Lib_Publish" (fun _ -> publish "Be.Vlaanderen.Basisregisters.AspNetCore.Mvc.Middleware.AddVersionHeader")
Target "Lib_Pack" (fun _ -> pack "Be.Vlaanderen.Basisregisters.AspNetCore.Mvc.Middleware.AddVersionHeader")
